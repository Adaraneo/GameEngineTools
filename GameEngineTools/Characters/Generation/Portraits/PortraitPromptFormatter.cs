...
namespace GameEngineTools.Characters.Generation.Portraits
{
    ...
    public sealed class PortraitPromptFormatter : IPortraitPromptFormatter
    {
        ...
        public string Format(PortraitSpec spec)
        {
            ...
            sb.Append($"Frame: {spec.Body.Frame.ToString().ToLowerInvariant()}, {spec.Body.FrameImpression}. ");
            ...
            sb.Append($"Hair: {spec.Hair.BaseColorFamily} hair, {spec.Hair.BrightnessRange} brightness, {spec.Hair.Straightness}, {spec.Hair.Texture}, {spec.Hair.VolumePolicy}. ");
