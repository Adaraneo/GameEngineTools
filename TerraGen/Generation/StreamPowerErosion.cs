...
public static class StreamPowerErosion
{
    ...
    public static void Erode(TerrainHeightmap grid, Parameters p, double[] upliftMetersPerYear, bool[]? locked = null,
        ...
        Action<int, int>? onIterationProgress = null)
    {
