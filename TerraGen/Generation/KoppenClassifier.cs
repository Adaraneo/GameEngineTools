...
/// <summary>Köppen–Geiger climate classification from 12 monthly (T,P) samples — independent port of WorldGen's own <c>KoppenClassifier</c> (Peel, Finlayson &amp; McMahon 2007, Hydrol. Earth Syst. Sci. 11:1633-1644; no project reference from TerraGen to WorldGen).</summary>
public static class KoppenClassifier
{
    /// <summary>Classifies one point from 12 calendar-ordered (Jan..Dec) monthly samples. <paramref name="isNorthernHemisphere"/> picks which 6 months count as the "winter"/"summer" half-year.</summary>
